...
class ConfigProcessor
{
    ...
    public int run()
    {
        ...
        {
            System.out.print("html2epub2: '" + this.configFile.getAbsolutePath() + "' doesn't exist.\n");
            System.exit(-4);
        }

        if (this.configFile.isFile() != true)
        {
            System.out.print("html2epub2: '" + this.configFile.getAbsolutePath() + "' isn't a file.\n");
            System.exit(-5);
        }

        if (this.configFile.canRead() != true)
        {
            System.out.print("html2epub2: '" + this.configFile.getAbsolutePath() + "' isn't readable.\n");
            System.exit(-6);
        }
                ...
                if (event.isStartElement() == true)
                {
                    ...
                    if (tagName.equalsIgnoreCase("inFile") == true)
                    {
                        ...
                        if (event.isCharacters() == true)
                        {
                            ...
                            {
                                System.out.print("html2epub2: '" + inFile.getAbsolutePath() + "' doesn't exist.\n");
                                System.exit(-7);
                            }

                            if (inFile.isFile() != true)
                            {
                                System.out.print("html2epub2: '" + inFile.getAbsolutePath() + "' isn't a file.\n");
                                System.exit(-8);
                            }

                            if (inFile.canRead() != true)
                            {
                                System.out.print("html2epub2: '" + inFile.getAbsolutePath() + "' isn't readable.\n");
                                System.exit(-9);
                            }
                            
                            if (title == null)
                            {
                                System.out.print("html2epub2: Missing title for '" + inFile.getAbsolutePath() + "' in configuration.\n");
                                System.exit(-10);
                            }
                    ...
                    else if (tagName.equalsIgnoreCase("outDirectory") == true)
                    {
                        ...
                        if (event.isCharacters() == true)
                        {
                            ...
                            {
                                System.out.print("html2epub2: Multiple out directories defined. Last one wins.\n");
                            }
                            ...
                            {
                                System.out.print("html2epub2: '" + outDirectory.getAbsolutePath() + "' doesn't exist.\n");
                                System.exit(-11);
                            }

                            if (outDirectory.isDirectory() != true)
                            {
                                System.out.print("html2epub2: '" + outDirectory.getAbsolutePath() + "' isn't a directory.\n");
                                System.exit(-12);
                            }

                            if (outDirectory.canWrite() != true)
                            {
                                System.out.print("html2epub2: '" + outDirectory.getAbsolutePath() + "' isn't writable.\n");
                                System.exit(-13);
                            }
                        }
                    }
        ...
        {
            System.out.print("html2epub2: No input files configured.\n");
            System.exit(-16);
        }

        if (this.outDirectory == null)
        {
            System.out.print("html2epub2: No output directory configured.\n");
            System.exit(-17);
        }
