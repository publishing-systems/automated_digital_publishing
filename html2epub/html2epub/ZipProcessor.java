    ...
    public void Run(ArrayList<File> packageFiles, File outDirectory)
    {
        try
        {
            ...
            
            {
                ...
                {
                    System.out.print("html2epub: '" + mimetypeFile.getAbsolutePath() + "' has an invalid file size of " + mimetypeFileSize + ", expected is " + mimetype.length() + ".\n");
                    System.exit(-64);
                }
                
                if (mimetypeFileSize > 1024)
                {
                    System.out.print("html2epub: Buffer size for mimetype file of " + mimetypeFileSize + " won't be sufficient.\n");
                    System.exit(-65);
                }
                ...
                {
                    System.out.print("html2epub: Problem with reading the mimetype file '" + mimetypeFile.getAbsolutePath() + "'.\n");
                    System.exit(-66);
                }
            }
