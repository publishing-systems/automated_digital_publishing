...
public class odt2html1
{
    ...
    {
        System.out.print("odt2html1 workflow  Copyright (C) 2014-2015  Stephan Kreutzer\n" +
        ...
        String programPath = odt2html1.class.getProtectionDomain().getCodeSource().getLocation().getPath();
