  ...
  implements ActionListener
{
    ...
    {
        System.out.print("odt2all1_config_edit1  Copyright (C) 2014  Stephan Kreutzer\n" +
        ...
        else
        {
            ...
            if (configFile.exists() != true)
            {
                try
                {
                    ...
                    writer.write("<!-- This file was created by odt2all1_config_edit1, which is free software licensed under the GNU Affero General Public License 3 or any later version (see https://github.com/publishing-systems/automated_digital_publishing/ and http://www.publishing-systems.org). -->\n");
    ...
    public odt2all1_config_edit1(File configFile)
    {
        ...
        JButton buttonHtml2epub1ConfigFile = new JButton("Choose");
        buttonHtml2epub1ConfigFile.addActionListener(this);
        
        gridbagConstraints.gridwidth = GridBagConstraints.REMAINDER;
        gridbagConstraints.fill = GridBagConstraints.HORIZONTAL;
        gridbagConstraints.weightx = 0.0;
        panelHtml2epub1ConfigFile.add(buttonHtml2epub1ConfigFile, gridbagConstraints);
...
class AboutDialog extends JDialog
{
    ...
    public final void generateGUI(JFrame parent)
    {
        ...
        JLabel notice = new JLabel("<html><head><title>asdf</title></head><body>" +
                                   "odt2all1_config_edit1  Copyright (C) 2014  Stephan Kreutzer<br/><br/>" +
