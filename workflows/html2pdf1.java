 ...
 *     template1 of odt2html to a PDF using pdflatex.
...
public class html2pdf1
{
    public static void main(String args[])
    {
        ...
        builder = new ProcessBuilder("java", "xsltransformator1", outputDirectory.getAbsolutePath() + File.separator + "input.html", programPath + ".." + File.separator + "html2latex" + File.separator + "html2latex1" + File.separator + "layout" + File.separator + "layout1.xsl", outputDirectory.getAbsolutePath() + File.separator + "output.tex");
        builder.directory(new File(programPath + ".." + File.separator + "xsltransformator" + File.separator + "xsltransformator1"));
        builder.redirectErrorStream(true);
