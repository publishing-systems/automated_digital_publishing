...
public class csv2xml2 {
    ...
    public void createNewDocument(String node) {
        ...
        catch (org.w3c.dom.DOMException e)
        {
            ...
            {
                System.out.println("csv2xml2: '" + node + "' isn't a valid XML root tag name. Please check the 'root-tag-name' setting in the configuration file.");
            }
    ...
    public int convert(InputStream csv, File configFile) {
        ...
        this.createNewDocument(rootTagName);
